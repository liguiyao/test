...
public class DataChartActivity extends SwipeActivity implements DataChartActivityImp {
    ...
    private String[] stateChar = {"Vegetables", "Fruits", "Foods", "Groceries", "Others"};
    ...
    private void initNicespinner(){//创建一个筛选器
        ...
        List<String> data=new LinkedList<>(Arrays.asList("pie chart","Histogram"));
    ...
    private void initToolbar(){
        ...
        getSupportActionBar().setTitle("Data analysis");
